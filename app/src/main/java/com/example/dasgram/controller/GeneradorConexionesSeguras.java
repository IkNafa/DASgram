...
/**
 * Clase Singleton que se encarga de crear una conexión segura con el servidor
 */
public class GeneradorConexionesSeguras {
    ...
    public HttpsURLConnection crearConexionSegura (Context contexto, String direccion) {
        ...
        try {
            ...
            InputStream caInput = new BufferedInputStream(contexto.getAssets().open("serv_cert.cer"));
